...
import './AnimationDrone.css';
import gsap, { Linear } from 'gsap';

const AnimationDrone = () => {
  useEffect(() => {
    gsap.to('.blade', 0.5, {
      rotation: 360,
      repeat: -1,
